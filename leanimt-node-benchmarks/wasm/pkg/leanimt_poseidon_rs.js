...
const LeanIMTPoseidonFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_leanimtposeidon_free(ptr >>> 0, 1));
/**
*/
class LeanIMTPoseidon {
    ...
    */
    update(index, new_leaf) {
        const ptr0 = passStringToWasm0(new_leaf, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
...
module.exports.LeanIMTPoseidon = LeanIMTPoseidon;
...
const path = require('path').join(__dirname, 'leanimt_poseidon_rs_bg.wasm');
