...
export interface InitOutput {
  ...
  readonly leanimtposeidon_index_of: (a: number, b: number, c: number, d: number) => void;
  ...
  readonly leanimtposeidon_insert_many: (a: number, b: number, c: number) => void;
  readonly leanimtposeidon_update: (a: number, b: number, c: number, d: number) => void;
  readonly leanimtposeidon_generate_proof: (a: number, b: number, c: number) => void;
